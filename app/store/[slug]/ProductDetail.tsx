...
export default function ProductDetail({ product, related }: Props) {
  ...
  return (
    <section className="mx-auto max-w-7xl px-5 pb-20 pt-32 lg:px-10">
      <nav aria-label="Breadcrumb" className="text-sm text-navy-950/50">
      ...
      <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-2">
        ...
        <Reveal direction="up" delay={80}>
          ...
          <p className="mt-5 flex items-baseline gap-3 font-serif text-3xl font-bold text-brand-600">
            ${product.price.toFixed(2)}
            {product.originalPrice && product.originalPrice > product.price && (
              <span className="text-lg font-normal text-navy-950/35 line-through">
